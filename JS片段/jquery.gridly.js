...
(function() {
    ...
    Draggable = (function() {
        ...
        Draggable.prototype.toggle = function(method) {
            ...
            this.$container[method]('mousedown touchstart', this.selector,
                this.began);
        ...
        Draggable.prototype.began = function(event) {
            ...
            return (ref = this.callbacks) != null ? typeof ref.began === "function" ? ref
                .began(event) :
                void 0 :
                void 0;
        };
        ...
        Draggable.prototype.ended = function(event) {
            ...
            delete this.$target;
            delete this.origin;
            return (ref = this.callbacks) != null ? typeof ref.ended === "function" ? ref
                .ended(event) :
                void 0 :
                void 0;
        };
        ...
        Draggable.prototype.moved = function(event) {
            ...
            event.preventDefault();
            event.stopPropagation();
            // if(this.$target[0].id != 'desc_pic_r' && this.$target[0].id !=
            // 'img-main' && this.dragged.id != 'desc_pic_r' && this.dragged.id
            // != 'img-main'){
            this.$target.css({
            ...
            // }
            return (ref = this.callbacks) != null ? typeof ref.moved === "function" ? ref
                .moved(event) :
                void 0 :
                void 0;
    ...
    Gridly = (function() {
        ...
        Gridly.prototype.ordinalize = function($elements) {
            ...
            results1 = [];
            for (i = j = 0, ref = $elements.length; 0 <= ref ? j <= ref :
                j >= ref; i = 0 <= ref ? ++j : --j) {
                $element = $($elements[i]);
        ...
        Gridly.prototype.$sorted = function($elements) {
            ...
            return ($elements || this.$('> *')).sort(function(a, b) {
                if (a.id == 'img-main' || a.id == 'desc_pic_r') {
                    return -1;
                }
                if (b.id == 'img-main' || b.id == 'desc_pic_r') {
                    return +1;
                }
        ...
        Gridly.prototype.draggingBegan = function(event) {
            ...
            return (ref = this.settings) != null ? (ref1 = ref.callbacks) != null ? typeof ref1.reordering === "function" ? ref1
                .reordering($elements) :
                void 0 :
                void 0 :
                void 0;
        ...
        Gridly.prototype.draggingEnded = function(event) {
            ...
            this.ordinalize($elements);
            setTimeout(this.layout, 0);
            return (ref = this.settings) != null ? (ref1 = ref.callbacks) != null ? typeof ref1.reordered === "function" ? ref1
                .reordered($elements, this._draggable.dragged) :
                void 0 :
                void 0 :
                void 0;
        };
        ...
        Gridly.prototype.draggingMoved = function(event) {
            ...
            $elements = (((ref1 = this.settings.callbacks) != null ? ref1.optimize :
                void 0) || this.optimize)($elements);
            for (i = k = 0, ref2 = $elements.length; 0 <= ref2 ? k < ref2 :
                k > ref2; i = 0 <= ref2 ? ++k : --k) {
        ...
        Gridly.prototype.size = function($element) {
            return (($element.data('width') || $element.outerWidth()) + this.settings.gutter) /
        ...
        Gridly.prototype.position = function($element, columns) {
            ...
            height = Infinity;
            column = 0;
            for (i = j = 0, ref = columns.length - size; 0 <= ref ? j < ref :
                j > ref; i = 0 <= ref ? ++j : --j) {
            ...
            for (i = k = ref1 = column, ref2 = column + size; ref1 <= ref2 ? k < ref2 :
                k > ref2; i = ref1 <= ref2 ? ++k : --k) {
                columns[i] = height +
                    ($element.data('height') || $element.outerHeight()) +
        ...
        Gridly.prototype.structure = function($elements) {
            ...
            columns = (function() {
                var j, ref, results1;
                results1 = [];
                for (i = j = 0, ref = this.settings.columns; 0 <= ref ? j <= ref :
                    j >= ref; i = 0 <= ref ? ++j : --j) {
                    results1.push(0);
                }
                return results1;
            }).call(this);
            for (index = j = 0, ref = $elements.length; 0 <= ref ? j < ref :
                j > ref; index = 0 <= ref ? ++j : --j) {
        ...
        Gridly.prototype.layout = function() {
            ...
            $elements = (((ref = this.settings.callbacks) != null ? ref.optimize :
                void 0) || this.optimize)(this.$sorted());
            structure = this.structure($elements);
            for (index = j = 0, ref1 = $elements.length; 0 <= ref1 ? j < ref1 :
                j > ref1; index = 0 <= ref1 ? ++j : --j) {
                $element = $($elements[index]);
                position = structure.positions[index];
                if ($element.is('.dragging')) {
                    continue;
                } // if($element[0].id != 'img-main' && $element[0].id !=
                // 'desc_pic_r'){
                $element.css({
                    position: 'absolute',
                    left: position.x,
        ...
        Gridly.prototype.optimize = function(originals) {
            ...
            while (originals.length > 0) {
                ...
                index = 0;
                for (index = j = 0, ref = originals.length; 0 <= ref ? j < ref :
                    j > ref; index = 0 <= ref ? ++j : --j) {
    ...
    $.fn.extend({
        gridly: function() {
            ...
            option = arguments[0], parameters = 2 <= arguments.length ? slice
                .call(arguments, 1) : [];
            if (option == null) {
                option = {};
            }
            return this.each(function() {
                ...
                $this = $(this);
                options = $.extend({}, $.fn.gridly.defaults,
