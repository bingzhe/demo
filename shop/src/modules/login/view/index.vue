        ...
        <div class="login-content">
            ...
            <div v-if="isShowlogin" class="login-left">
                <el-form class="login-form" :model="loginForm">
                    ...
                    <el-form-item>
                        <el-button v-if="isShowSubmitBtn" class="submit" type="primary" @click="login">登陆</el-button>
                        <el-button v-else class="disabled" type="primary" :disabled="true">登陆</el-button>
                    </el-form-item>
                </el-form>
            </div>
            <!-- login end -->
