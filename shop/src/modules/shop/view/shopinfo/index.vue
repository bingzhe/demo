		...
		<section class="industrialInformation">
			...
			<div class="info clearfix">
				<div class="content left lf">
					<p class="enterpriseName grey">企业名称：<span class="black"></span> <span class="changePassword nobind">(未认证)</span></p>
					<p class="legalrePresentative grey">法人代表：<span class="black"></span> <span class="nobind">(未认证)</span></p>
					<p class="legalpersonPhone grey">法人手机号：<span class="black call"></span> <span class="unbundling nobind">(未认证)</span></p>
					<p class="legalpersonNum grey">企业法人身份证号码:  <span class="unbundling nobind">(未认证)</span></p>
					...
					<p class="businessScope grey">经营范围：餐饮</p>
				</div>
				<div class="content left rf">
					<p class="businessLicense grey">营业执照注册号：<span class="black"></span> <span class="or nobind">(未认证)</span></p>
					<p class="businessTerm grey">营业期限：<span class="black"></span> <span class="unbundling or nobind">(未认证)</span> </p>
					<p class="scanning grey">营业执照扫描件：<span class="or nobind">(未认证)</span></p>
					<div class="dentificationCard"></div>
					<p class="permit grey">餐饮服务许可证编号: <span class="black"></span> <span class="or nobind">(未认证)</span></p>
